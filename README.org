...
- [[#mu4e-alert][mu4e alert]]
  ...
  - [[#customizations][Customizations]]
    ...
    - [[#customizing-the-desktop-notifications][Customizing the desktop notifications]]
      ...
      - [[#customizing-notification-sounds][Customizing notification sounds]]
...
**** Customizing notification sounds
     ~mu4e-alert~ can now play a sound when a new mail is received.

     The following variables can be used to customize the notification sounds.

     |-------------------------+--------------------------------------------------------------------------------|
     | Variable                | Aspect customized                                                              |
     |-------------------------+--------------------------------------------------------------------------------|
     | mu4e-alert-audio-player | Music player used to play sounds (by default, search for ~aplay~)                |
     | mu4e-alert-sound        | The path to a sound file that's to be played when a new mail is received       |
     | mu4e-alert-sound-p      | Boolean value to determine whether to play a sound when a new mail is received |
     | mu4e-alert-sound-args   | Arguments used when playing ~mu4e-alert-sound~                                   |
     |-------------------------+--------------------------------------------------------------------------------|
